<!-- resources/views/inven/lineas/create.blade.php -->
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container mt-4">
        <h1 class="mb-4">Crear Nueva Línea</h1>
        ...
        <div class="form-container">
            ...
            <div class="buttons-section">
                <div class="manual-section">
                    ...
                    <a href="{{ route('lineas.create') }}" class="btn btn-success">Crear Línea</a>
                    <a href="{{ route('tipos.create') }}" class="btn btn-primary">Crear Tipo</a>
                    <a href="{{ route('grupos.create') }}" class="btn btn-warning">Crear Grupo</a>
